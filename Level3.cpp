...
void Level3::DestroyWall(int Y, int X)
{
	tileDest[Y][X] = 0;
...
void Level3::SetEnemyPos()
{
	...
	Puropen_Enemy2->setPosition(384, 15);
...
int Level3::getTileHeight()
{
	return _tileHeight;
}

int Level3::getTileWidth()
{
	return _tileWidth;
}

int Level3::getHeight()
{
	return _sheetWidth;
}
...
int Level3::getGridPosX(int PosX)
{
	int TileX = PosX / _tileWidth;
	return TileX;
}

int Level3::getGridPosY(int PosY)
{
	int TileY = PosY / _tileHeight;
	return TileY;
}

int Level3::getIDfromLayer(int layer, int PosX, int PosY)
{
	int TileX = PosX / _tileWidth;
	int TileY = PosY / _tileHeight;
	if (layer == 0) {
